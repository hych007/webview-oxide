...
UBUNTU_TRANSLATION_DOMAIN="webview-oxide.liu-xiao-guo"
...
aptest.commands = bash $$PWD/webview-oxide/tests/autopilot/run
aptest.depends  = sub-webview-oxide

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/webview-oxide/tests/unit
unittest.depends  = sub-webview-oxide
